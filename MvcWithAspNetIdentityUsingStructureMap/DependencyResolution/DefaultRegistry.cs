...
namespace MvcWithAspNetIdentityUsingStructureMap.DependencyResolution {
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry() {
            ...
            ForConcreteType<IdentityDbContext>().Configure.SelectConstructor(() => new IdentityDbContext("connection string ctor")).Ctor<string>().Is("IdentitySetupWithStructureMap");
        }
